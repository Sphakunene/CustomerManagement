...
namespace CustomerManagementApp {
    ...
    public partial class CUSTOMERDataSet : global::System.Data.DataSet {
        ...
        public partial class CustomerDataTable : global::System.Data.TypedTableBase<CustomerRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public CustomerRow AddCustomerRow(string Name, string Surname, int PhoneNumber, string EmailAddress, string City, string ZipCode) {
...
namespace CustomerManagementApp.CUSTOMERDataSetTableAdapters {
    ...
    public partial class CustomerTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Customer] WHERE (([ID] = @Original_ID) AND ([Name] = @Original_Name) AND ([Surname] = @Original_Surname) AND ([PhoneNumber] = @Original_PhoneNumber) AND ([EmailAddress] = @Original_EmailAddress) AND ([City] = @Original_City) AND ([ZipCode] = @Original_ZipCode))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Customer] ([Name], [Surname], [PhoneNumber], [EmailAddress], [City], [ZipCode]) VALUES (@Name, @Surname, @PhoneNumber, @EmailAddress, @City, @ZipCode);
SELECT ID, Name, Surname, PhoneNumber, EmailAddress, City, ZipCode FROM Customer WHERE (ID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Customer] SET [Name] = @Name, [Surname] = @Surname, [PhoneNumber] = @PhoneNumber, [EmailAddress] = @EmailAddress, [City] = @City, [ZipCode] = @ZipCode WHERE (([ID] = @Original_ID) AND ([Name] = @Original_Name) AND ([Surname] = @Original_Surname) AND ([PhoneNumber] = @Original_PhoneNumber) AND ([EmailAddress] = @Original_EmailAddress) AND ([City] = @Original_City) AND ([ZipCode] = @Original_ZipCode));
SELECT ID, Name, Surname, PhoneNumber, EmailAddress, City, ZipCode FROM Customer WHERE (ID = @ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::CustomerManagementApp.Properties.Settings.Default.CUSTOMERConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Name, Surname, PhoneNumber, EmailAddress, City, ZipCode FROM dbo.Custo" +
                "mer";
        ...
        public virtual int Delete(int Original_ID, string Original_Name, string Original_Surname, int Original_PhoneNumber, string Original_EmailAddress, string Original_City, string Original_ZipCode) {
        ...
        public virtual int Insert(string Name, string Surname, int PhoneNumber, string EmailAddress, string City, string ZipCode) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, string Surname, int PhoneNumber, string EmailAddress, string City, string ZipCode, int Original_ID, string Original_Name, string Original_Surname, int Original_PhoneNumber, string Original_EmailAddress, string Original_City, string Original_ZipCode, int ID) {
            if ((Name == null)) {
                throw new global::System.ArgumentNullException("Name");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[9].Value = ((int)(Original_PhoneNumber));
            if ((Original_EmailAddress == null)) {
                throw new global::System.ArgumentNullException("Original_EmailAddress");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Surname, int PhoneNumber, string EmailAddress, string City, string ZipCode, int Original_ID, string Original_Name, string Original_Surname, int Original_PhoneNumber, string Original_EmailAddress, string Original_City, string Original_ZipCode) {
            return this.Update(Name, Surname, PhoneNumber, EmailAddress, City, ZipCode, Original_ID, Original_Name, Original_Surname, Original_PhoneNumber, Original_EmailAddress, Original_City, Original_ZipCode, Original_ID);
        }
    }
